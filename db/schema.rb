...
ActiveRecord::Schema.define(version: 20160125230514) do
  ...
  create_table "links_occasions", force: :cascade do |t|
    t.integer  "link_id"
  ...
  create_table "links_pets", force: :cascade do |t|
    t.integer  "link_id"
    t.integer  "pet_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "links_places", force: :cascade do |t|
    t.integer  "link_id"
    t.integer  "place_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "occasions_administrations", force: :cascade do |t|
    t.integer  "occasion_id"
  ...
  create_table "pets_administrations", force: :cascade do |t|
    t.integer  "pet_id"
    t.integer  "administrator_id"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
  ...
  create_table "place_administrations", force: :cascade do |t|
    t.integer  "place_id"
    t.integer  "administrator_id"
    t.datetime "created_at",       null: false
    t.datetime "updated_at",       null: false
